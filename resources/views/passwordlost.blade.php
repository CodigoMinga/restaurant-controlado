...
<div class="middle">
      ...
      <div id="login">
        <h3 style="color:white; text-align:center">Ingrese correo</h3>
        <br>
...
@endif
        <form action="{{url('/app/login/passwordlost/process')}}" method="post">
          {{csrf_field()}}
          <fieldset class="clearfix">
            ...
            <p ><span class="fa fa-envelope"></span><input type="text"  Placeholder="Email" name="email" required></p> 
             ...
             <span style="width:50%; text-align:center; display: inline-block;"><input type="submit" value="Enviar"></span>
            </div>
